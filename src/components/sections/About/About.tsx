...
const BentoCard = ({
  ...
  <motion.div
    ...
    className={`relative group overflow-hidden glass-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/5 hover:border-white/20 transition-all duration-500 ${className}`}
  >
...
export function About() {
  return (
    <div className="relative w-full min-h-full lg:h-full flex items-center justify-center overflow-x-hidden lg:overflow-hidden bg-[#0a0d17]">
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-12 relative z-10 min-h-full lg:h-full flex flex-col justify-center">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="mb-4 sm:mb-10 text-left">
            ...
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              className="text-2xl sm:text-4xl md:text-5xl xl:text-6xl font-black text-white"
            >
              Beyond the{" "}
          ...
          {/* Bento Grid Layout */}
          <div className="grid grid-cols-2 md:grid-cols-4 md:grid-rows-3 gap-2 sm:gap-4 h-auto md:h-120">
            {/* Biography Card - Large */}
            <BentoCard className="col-span-2 md:col-span-2 md:row-span-2 flex flex-col justify-center">
              <div className="flex justify-between items-start">
                <div className="mb-2 sm:mb-3 inline-flex p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-purple-500/10 text-purple-400">
                  <Sparkles size={24} className="sm:w-8 sm:h-8" />
                </div>
                <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-cyan-500 animate-ping" />
              </div>
              <h3 className="text-xl sm:text-3xl font-bold text-white mb-2 sm:mb-4">
                The Story So Far
              </h3>

              <p className="text-white/60 leading-relaxed text-xs sm:text-sm md:text-base mb-3 sm:mb-6">
                I am{" "}
            ...
            <BentoCard className="md:col-span-1 md:row-span-1 bg-gradient-to-br from-blue-500/10 to-transparent">
              ...
              <div>
                <div className="text-xl sm:text-3xl font-black text-white">15+</div>
                <div className="text-[10px] sm:text-xs text-white/60 mt-1">
                  Projects Delivered
                </div>
              </div>
            ...
            <BentoCard className="md:col-span-1 md:row-span-1 flex flex-col justify-between border-cyan-500/10">
              ...
              <div>
                <div className="text-lg sm:text-3xl font-bold text-white">Lahore, PK</div>
            ...
            <BentoCard className="md:col-span-1 md:row-span-1 bg-gradient-to-br from-emerald-500/10 to-transparent">
              ...
              <div>
                <div className="text-xl sm:text-3xl font-black text-white flex items-center gap-1">
                  4.9<span className="text-base sm:text-xl text-emerald-400">/5</span>
                </div>
                <div className="text-[10px] sm:text-xs text-white/60 mt-1">Client Rating</div>
              </div>
            </BentoCard>
            {/* Team Collaboration Card - Wide */}
            <BentoCard className="col-span-2 md:col-span-2 md:row-span-1 bg-gradient-to-br from-pink-500/10 to-transparent flex flex-col justify-center">
              <div className="flex items-center gap-2 sm:gap-4 mb-2 sm:mb-4">
                <div className="p-1.5 sm:p-2 rounded-lg bg-pink-500/10">
                  <Users className="text-pink-400 w-5 h-5 sm:w-8 sm:h-8" />
                </div>
            ...
            <BentoCard className="col-span-2 md:col-span-2 md:row-span-1 flex flex-col justify-center border-indigo-500/10">
              <div className="flex items-center gap-2 sm:gap-4 mb-2 sm:mb-4">
                <div className="p-1.5 sm:p-2 rounded-lg bg-indigo-500/10">
                  <Cpu className="text-indigo-400 w-5 h-5 sm:w-8 sm:h-8" />
                </div>
                <span className="text-xs font-bold text-white/40 uppercase tracking-widest">
                  Preferred Stack
                </span>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                {[
                  ...
                  <div key={tech.name} className="flex items-center gap-1.5 sm:gap-2">
